...
const pixivRankingSources: CrawlSource[] = [
  { id: 'builtin_pixiv_daily_p1', name: 'Pixiv日榜-p1', url: 'https://www.pixiv.net/ranking.php?mode=daily&content=illust&format=json&p=1', category: 'anime', enabled: true, responseType: 'pixiv' },
  { id: 'builtin_pixiv_daily_p2', name: 'Pixiv日榜-p2', url: 'https://www.pixiv.net/ranking.php?mode=daily&content=illust&format=json&p=2', category: 'anime', enabled: true, responseType: 'pixiv' },
  { id: 'builtin_pixiv_daily_p3', name: 'Pixiv日榜-p3', url: 'https://www.pixiv.net/ranking.php?mode=daily&content=illust&format=json&p=3', category: 'anime', enabled: true, responseType: 'pixiv' },
  { id: 'builtin_pixiv_daily_p4', name: 'Pixiv日榜-p4', url: 'https://www.pixiv.net/ranking.php?mode=daily&content=illust&format=json&p=4', category: 'anime', enabled: true, responseType: 'pixiv' },
  { id: 'builtin_pixiv_daily_p5', name: 'Pixiv日榜-p5', url: 'https://www.pixiv.net/ranking.php?mode=daily&content=illust&format=json&p=5', category: 'anime', enabled: true, responseType: 'pixiv' },
