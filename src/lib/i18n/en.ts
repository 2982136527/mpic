const en = {
  ...
  admin: {
    ...
    crawlStartContinuous: 'Start Continuous Crawl',
    crawlStopContinuous: 'Stop Continuous Crawl',
    crawlContinuousStarting: 'Starting...',
    crawlContinuousStopping: 'Stopping...',
    crawlContinuousNote: 'Continuous crawl is driven by this admin page. Keep this page open to keep chaining batches; closing it or stopping will end the loop.',
