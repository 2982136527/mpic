const zh = {
  ...
  admin: {
    ...
    crawlSettings: '采集设置',
    crawlEnabled: '启用自动采集',
    crawlStartContinuous: '启动持续采集',
    crawlStopContinuous: '停止持续采集',
    crawlContinuousStarting: '启动中...',
    crawlContinuousStopping: '停止中...',
    crawlContinuousNote: '持续采集由当前后台页面接力执行。保持本页面打开时，会一轮接一轮持续采集；关闭页面或点停止后会结束。',
